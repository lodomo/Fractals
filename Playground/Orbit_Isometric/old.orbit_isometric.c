...
int main() {
    ...
    Body earth;
    earth.orbit_radius_x = 300;
    earth.orbit_radius_y = 150;
    earth.orbit_position = 0;
    earth.radius = 50;
    // Real orbit is 365.26 days, but 365 to get a clean end orbit.
    earth.day_rads = 2 * M_PI / 365;
    earth.x = sun.x + earth.orbit_radius_x * cos(earth.orbit_position);
    earth.y = sun.y + earth.orbit_radius_y * sin(earth.orbit_position);
    earth.r = 0;
    earth.g = 0;
    earth.b = 1;
    ...
    Body moon;
    moon.orbit_radius_x = 100;
    moon.orbit_radius_y = 50;
    moon.orbit_position = 0;
    moon.radius = 20;
    // Real orbit is 27.3 but 28 to get a clean end orbit
    moon.day_rads = 2 * M_PI / 28;
    moon.x = earth.x + moon.orbit_radius_x * cos(moon.orbit_position);
    moon.y = earth.y + moon.orbit_radius_y * sin(moon.orbit_position);
    moon.r = 1;
    moon.g = 1;
    moon.b = 1;
