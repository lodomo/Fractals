...
int Gi_wait_click(int *);
int G_wait_click(double *);
int G_wait_key();
int G_no_wait_key();
static int sector(double, double, double, double, double, double *, double *, int);
...
double G_y_mouse();
int get_timeI(int *);
int get_timeD(double *);
int get_time(double *);
int G_get_time(double *);
